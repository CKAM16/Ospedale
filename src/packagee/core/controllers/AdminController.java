...
import packagee.core.model.persistence.Storage.getInstance();
...
public class AdminController {
    public Response registrarAdministrador(Administrator a) {
        ...
        for (Administrator existente : Storage.getInstance().getPersons;) {
    ...
    public Response actualizarAdministrador(String id, Administrator nuevosDatos) {
        for (Administrator a : Storage.getInstance().getPersons;) {
